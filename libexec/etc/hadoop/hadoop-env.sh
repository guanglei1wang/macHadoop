...
export HDFS_NAMENODE_USER="jing"
export HDFS_DATANODE_USER="jing"
export HDFS_SECONDARYNAMENODE_USER="jing"
export YARN_RESOURCEMANAGER_USER="jing"
export YARN_NODEMANAGER_USER="jing"
